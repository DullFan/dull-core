...
public class SpElUtil {
    ...
    private static final DullBoxExpressionEvaluator expressionEvaluator = new DullBoxExpressionEvaluator();
    ...
    @Data
    @AllArgsConstructor
    private static class DullBoxExpressionRootObject {
     ...
     */
    @Data
    private static class DullBoxExpressionEvaluator extends CachedExpressionEvaluator {
        ...
        private EvaluationContext createEvaluationContext(String className,
            ...
            DullBoxExpressionRootObject root = new DullBoxExpressionRootObject(className, methodName, classType, method, args, parameterTypes, target);
